...
const CATEGORIES = [
  { key: 'testing', icon: 'analytics' as const, color: '#0066FF' },
  { key: 'training', icon: 'barbell' as const, color: '#10B981' },
  { key: 'recovery', icon: 'bed' as const, color: '#8B5CF6' },
  { key: 'nutrition', icon: 'restaurant' as const, color: '#F97316' },
];
    ...
    <FeatureScrollScreen title={t('features.knowledge.title')}>
      ...
      {CATEGORIES.map((cat) => (
        <Card
          ...
          variant="elevated"
          padding="md"
          style={{ marginBottom: theme.spacing.md, borderRadius: theme.borderRadius['2xl'] }}
        >
